...
deepspeed --num_gpus=3 lora.py --deepspeed ds_z3_bf16_config.json --output_dir './chat-gpt-neo-1.3B_merged-3e' --lora_r 16 \
	--data_path './vi_merged.jsonl' --batch_size 180 --per_device_batch_size 20 --num_epochs 3
